...
(async () => {
  ...
  console.log('PASS: 18 scenes / 4 groups / 4 models; badges; lean first paint then full-scene prefetch; cached playback; confidence; reload; failure/retry; race; mobile; no JS errors');
  await browser.close();
